...
public class BookMain {
	...
	public static void main(String[] args) {
		...
		for (Book book : bookStore.getBooksList()) {
			System.out.printf("Book name: %s - Author: %s - ISBN: %s [Publisher: %s]%n", book.getName(), book.getAuthor(),
					book.getIsbn(), book.getPublisher());
		}

		Book book = readSingleBookJSON("./book.json");
		System.out.printf("Book name: %s - Author: %s - ISBN: %s [Publisher: %s]%n", book.getName(), book.getAuthor(), book.getIsbn(),
				book.getPublisher());
	}
